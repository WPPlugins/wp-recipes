...
function recipes_setupBoxes() {
  wp_enqueue_style('my_meta_css-klantenreactie', '/wp-content/plugins/wp-recipes/lib/css/styles.boxes.css');
  wp_enqueue_style('my_meta_css_fotos-klantenreactie', '/wp-content/plugins/wp-recipes/lib/css/styles.fotoupload.css');
...
function recipesBoxGeneral() {
  ...
  include(WP_PLUGIN_DIR . '/wp-recipes/metaboxes/metaGeneral.php');
...
function recipesBoxIngredients() {
  global $post;
  $meta = get_post_meta($post->ID,'_my_meta',TRUE);
  include(WP_PLUGIN_DIR . '/wp-recipes/metaboxes/metaIngredients.php');
}

function recipesBoxInstructions() {
  global $post;
  $meta = get_post_meta($post->ID,'_my_meta',TRUE);
  include(WP_PLUGIN_DIR . '/wp-recipes/metaboxes/metaInstructions.php');
}
...
function recipes_admin_scripts() {
  ...
  wp_register_script('my-upload-klantenreactie', '/wp-content/plugins/wp-recipes/lib/src/functions.upoader.js', array('jquery','media-upload','thickbox'));
